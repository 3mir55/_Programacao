...
import br.com.essyx.exerciciossb.model.repositories.ProdutoRepository;
...
//	@PostMapping
	...
	public @ResponseBody Produto salvarProduto(@Valid Produto produto) { // maneira simplificada do método anterior
