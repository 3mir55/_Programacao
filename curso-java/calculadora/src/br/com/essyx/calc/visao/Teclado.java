package br.com.essyx.calc.visao;
...
import br.com.essyx.calc.modelo.Memoria;
...
public class Teclado extends JPanel implements ActionListener{
	...
	public Teclado() {
		...
		//Linha 1
//		c.gridwidth = 2; //usado pra aumentar a largura dos botões
		adicionarBotao("AC", COR_CINZA_ESCURO, c, 0, 0);
//		c.gridwidth = 1; //faz os botões abaixo voltarem para largura normal
